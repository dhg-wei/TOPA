...
--max_seq_len 128 --batch_size 10 --epochs 1 --warmup_epochs 2 --bias 3 --tau 100. --max_feats 10 --dataset star \
...
--output_dir results/llama2_13B/star \
--llama2 --llama_model_path ./pretrained/llama2/ \
--memory \


torchrun --rdzv_endpoint 127.0.0.1:1234 --nproc_per_node 4 train.py --model 7B \
--max_seq_len 128 --batch_size 10 --epochs 5 --warmup_epochs 2 --bias 3 --tau 100. --max_feats 10 --dataset star \
...
--output_dir results/llama2_7B/star \
--llama2 --llama_model_path ./pretrained/llama2/ \
--memory \


torchrun --rdzv_endpoint 127.0.0.1:1234 --nproc_per_node 4 train.py --model 8B \
--max_seq_len 150 --batch_size 10 --epochs 5 --warmup_epochs 2 --bias 3 --tau 100. --max_feats 10 --dataset star \
...
--output_dir results/llama3_8B/star \
