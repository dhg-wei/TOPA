...
--output_dir results/llama2_13B/egos \
...
--output_dir results/llama2_7B/egos \
--llama2 --llama_model_path ./pretrained/llama2/ \
--memory \
--test

torchrun --rdzv_endpoint 127.0.0.1:1234 --nproc_per_node 1 train.py --model 8B \
--max_seq_len 150 --batch_size 1 --epochs 5 --warmup_epochs 2 --bias 3 --tau 100. --max_feats 10 --dataset egos \
...
--output_dir results/llama3_8B/egos \
