...
--max_seq_len 150 --batch_size 10 --epochs 1 --warmup_epochs 2 --bias 3 --tau 100. --max_feats 10 --dataset tvqa \
...
--output_dir results/llama2_13B/tvqa \
...
--output_dir results/llama2_7B/tvqa \
--llama2 --llama_model_path ./pretrained/llama2/ \
--memory \
...
--output_dir results/llama3_8B/tvqa \
